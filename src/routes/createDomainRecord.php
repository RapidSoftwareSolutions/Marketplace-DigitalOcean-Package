...
$app->post('/api/DigitalOcean/createDomainRecord', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','domain','type']);
    ...
    $query_str = "https://api.digitalocean.com/v2/domains/{$data['domain']}/records";
