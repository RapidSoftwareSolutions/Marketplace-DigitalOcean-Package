...
$app->post('/api/DigitalOcean/createDroplet', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','name','region','size','image']);
    ...
    $requiredParams = ['accessToken'=>'accessToken','name'=>'name','region'=>'region','size'=>'size','image'=>'image'];
