...
$app->post('/api/DigitalOcean/deleteSshKey', function ($request, $response) {
    ...
    $query_str = "https://api.digitalocean.com/v2/account/keys/{$data['id']}";
    ...
    try {
        ...
        if(in_array($resp->getStatusCode(), ['200', '201', '202', '203', '204'])) {
            ...
            if(empty($result['contextWrites']['to'])) {
                $result['contextWrites']['to']['status_msg'] = "SSH key successfully deleted!";
            }
        } else {
