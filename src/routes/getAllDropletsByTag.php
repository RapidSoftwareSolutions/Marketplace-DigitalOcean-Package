...
$app->post('/api/DigitalOcean/getAllDropletsByTag', function ($request, $response) {
    ...
    $optionalParams = ['tagName'=>'tag_name','page'=>'page','perPage'=>'per_page'];
    $bodyParams = ['tag_name','page','per_page'];
